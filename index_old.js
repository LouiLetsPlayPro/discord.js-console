...
function logInfo(message, logchannel, client) {
    try {
        if (client == undefined) return;
        if (logchannel == undefined) return;
...
module.exports.console = class {
    ...
    static consolebuilder(
        ...
        if(channellog == true){
            if(logchannel == 0){
                throw new Error("No Log Channel ID in the consolebuilder")
            }
            if(client == 0){
                throw new Error("No valid discord.js Client in the consolebuilder")
            }
        }
    ...
    */
    ...
    static logInfo(message){
        ...
        if (this.time == true && this.color == true) {
            console.log("\u001b[30;1m" + getTimestamp() + "\u001b[34m INFO \u001b[0m" + message);
        }
        if (this.time == false && this.color == true) {
